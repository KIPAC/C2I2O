...
class LogGridParams(GridParams):
    ...
    min_value: float = Field(..., description="Minimum value for grid", ge=0.)
...
class LinearZGridParams(LinearGridParams):
    ...
    min_value: float = Field(0., description="Minimum value for grid", ge=0.)
    max_value: float = Field(..., description="Maximum value for grid")
...
class LogKGridParams(LogGridParams):
    ...
    min_value: float = Field(1e-4, description="Minimum value for wavenumber grid [Mpc-1]", gt=0.)
    max_value: float = Field(1e1, description="Maximum value for wavenumber grid [Mpc-1]", gt=0.)
